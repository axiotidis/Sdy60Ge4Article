...
Μια σημαντική διάσταση της “**έξυπνης πόλης**” είναι η μετακίνηση εντός του αστικού ιστού. Στη διεθνή βιβλιογραφία υπάρχουν πολλές προτάσεις για την υλοποίηση της “**έξυπνης μετακίνησης**” αρκετές από τις οποίες εφαρμόζονται ήδη στην πράξη. Μια άλλη διάσταση της έξυπνης πόλης σχετίζεται με την ανάδειξη και την αύξηση της επισκεψιμότητας σε μνημεία και χώρους πολιτιστικής κληρονομιάς της πόλης, ο σχεδιασμός της εφαρμογής μας έχει ως σκοπό να εξυπηρετήσει την υλοποίηση ενός συγκερασμού των δύο τομέων στην πόλη της Κομοτηνής,  μια εφαρμογή σε επιτραπέζια (web), κινητή (mobile) και φορετή (smartwatch) μορφή την οποία θα τη χρησιμοποιούν οι επισκέπτες της πόλης για να ενοικιάζουν ηλεκτρικά πατίνια με τα οποία θα περιηγούνται στους πολιτιστικούς χώρους και στα ιστορικά μνημεία της Κομοτηνής. 
...
*Εικόνα 22. Ο κώδικας για την πρώτη σελίδα της Smartwatch έκδοσης (index.html)*

Ο κώδικας βρίσκεται αναρτημένος σε δημόσιο αποθετήριο στο [github](https://github.com/axiotidis/wscooter) και παρακάτω παραθέτουμε εικόνες από την φορετή εφαρμογή. 

![](pics/pic_23.png)

*Εικόνα 23. Σύνοψη των οθονών της φορετής εφαρμογής*
...
Πραγματοποιήσαμε αξιολόγηση της ευχρηστίας σε διάφορα σημεία του κέντρου της Κομοτηνής για την κινητή εφαρμογή και σε οικίες ή χώρους εργασίας για τη desktop εφαρμογή. Για τη διαδικασία των πειραμάτων χρησιμοποιήθηκε ένα κινητό τηλέφωνο τύπου smartphone και ένας φορητός υπολογιστής. Η χρήση του πατινιού προσομοιώθηκε από γρήγορο βάδισμα.  O κάθε χρήστης χρησιμοποίησε αρχικά την κινητή και στη συνέχεια την desktop έκδοση της εφαρμογής για να επιτελέσει δύο φορές μια σειρά λειτουργιών  που του δόθηκαν εγγράφως. Μετά το τέλος των δύο κύκλων της εκτέλεσης του σεναρίου κάθε έκδοσης της εφαρμογής, ο χρήστης συμπλήρωσε ένα ξεχωριστό για την κάθε έκδοση ερωτηματολόγιο που σχεδιάστηκε σε google forms με σκοπό την αξιολόγηση της ευχρηστίας. Τα ερωτηματολόγια καθώς και απαντήσεις των χρηστών βρίσκονται:

* Για τη κινητή εφαρμογή [εδώ](https://docs.google.com/forms/d/e/1FAIpQLSfZXpp12ruIaNY8lO1Y2C3Yw8PkGTutjLdSkjTGwLkP8d2A5w/viewanalytics)

* Για την επιτραπέζια εφαρμογή [εδώ](https://docs.google.com/forms/d/e/1FAIpQLSctYY6onBIz2ty74tCakl_wf-8z4nn9tnRN-Y6SMM0MfocSVQ/viewanalytics)

![](pics/pic_27.png)

*Εικόνα 27. Ταυτότητα της έρευνας*

### **4. Αποτελέσματα αξιολόγησης και επανασχεδιασμός**

**4.1 Αποτελέσματα αξιολόγησης**

**4.1.1. Επιτραπέζια εφαρμογή**

![](pics/pic_28.jpg)

*Εικόνα 28. Αποτελέσματα της αξιολόγησης αποτελεσματικότητας*

![](pics/pic_29.jpg)

*Εικόνα 29. Αποτελέσματα της αξιολόγησης ευχρηστίας*

**4.1.2. Κινητή εφαρμογή**

![](pics/pic_30.png)

*Εικόνα 30. Αποτελέσματα της αξιολόγησης αποτελεσματικότητας*

![](pics/pic_31.jpg)

*Εικόνα 31. Αποτελέσματα της αξιολόγησης ευχρηστίας*

**4.2 Μια επιγραμματική αξιολόγηση των αποτελεσμάτων**
...
* Συνδυάζοντας τις μετρήσεις χρόνου από το time line του video, τις μετρήσεις χρόνου από το log file του mousotron και τις ενδείξεις του μέσου όρου χρόνου αφοσίωσης από τα google analytics όσον αφορά τη σελίδα signup.html (user registration), διαπιστώθηκε ότι η λειτουργία εγγραφής νέου χρήστη καθυστερούσε περισσότερο τους χρήστες σε σχέση με άλλες λειτουργίες, ειδικά στην κινητή έκδοση της εφαρμογής. 
Εστιάζοντας στην κινητή έκδοση της εφαρμογής εκτιμούμε ότι εν μέρει αυτή η καθυστέρηση οφείλεται στη δυσκολία πληκτρολόγησης των στοιχείων των χρηστών μέσω του soft keyboard. 
Παρατηρώντας στη συνέχεια τα videos στα οποία καταγράψαμε τις κινήσεις των χρηστών, διαπιστώσαμε επίσης ότι κατά την πρώτη επαφή του χρήστη με την κινητή εφαρμογή δε γίνονται αμέσως αντιληπτά τα buttons Sign Up και Sign In και ο χρήστης θα πρέπει να “σύρει” την οθόνη προς τα επάνω για να αποκαλυφθούν. Μια δεύτερη παρατήρηση από την εξέταση των videos έχει να κάνει με τη δυσκολία που συνάντησαν οι χρήστες στην εισαγωγή της ημερομηνίας γέννησης με βάση την οποία ελέγχουμε αν ο χρήστης είναι ενήλικος ή όχι, αυτά τα σημεία της εφαρμογής στη συνέχεια βελτιώθηκαν. 
...
*Εικόνα 32. Ανασχεδιασμός της ιστοσελίδας index.html έτσι ώστε να μην κρύβονται τα button* 
...
*Εικόνα 33. Ανασχεδιασμός της ιστοσελίδας signup.html για γργορότερη εγγραφή ενός χρήστη* 
...
*Εικόνα 34. Προσθήκη πεδίου “info” στη βάση δεδομένων για απεικόνιση περισσότερων πληροφοριών*

![](pics/pic_35.jpg)

*Εικόνα 35. Απεικόνιση περισσότερων πληροφοριών των ιστορικών μνημείων*

### **Συμπεράσματα**

Κατά την υλοποίηση της εφαρμογής δεν επιτύχαμε να αποδώσουμε τη διάκριση μεταξύ της web και της mobile εφαρμογής.
Από την αξιολόγηση αποτελεσματικότητας φάνηκε ότι οι χρήστες έμαθαν εύκολα την εφαρμογή, ένα σημείο που προκαλούσε καθηστέρηση κατά την εγγραφή νέου χρήστη διορθώθηκε.
Από την αξιολόγηση ευχρηστίας πήραμε γενικά θετική ανάδραση από τους χρήστες με ελάχιστες παρατηρήσεις που μας βοήθησαν να βελτιώσουμε κάποια σημεία της εφαρμογής.
