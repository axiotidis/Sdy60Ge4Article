...
Ως βάση δεδομένων και για τις τρεις εκδοχές της εφαρμογής  χρησιμοποιήθηκαν οι servers που παρέχει η Google διαμέσου της εφαρμογής της Firebase. Η βάση δεδομένων αποτελείται από τα παρακάτω τρία τμήματα:
...
Για την υλοποίηση της επιτραπέζιας εφαρμογής(web)  χρησιμοποιήθηκε η γλώσσα σήμανσης **HTML5**, η γλώσσα διαμόρφωσης της εμφάνισης ιστοσελίδων **CSS3** καθώς και η **javascript**. Για το σχεδιασμό της **back end** αρχιτεκτονικής, για τη δημιουργία μιας βάσης δεδομένων δηλαδή και την επικοινωνία με αυτήν, έγινε χρήση  της **Google Firebase**.  Σε αυτές τις γλώσσες στηρίχθηκε και η δημιουργία της Smartwatch εκδοχής της εφαρμογής ενώ για την κατασκευή της κινητής (mobile) εφαρμογής χρησιμοποιήθηκε το wrapper **android webView**. 
